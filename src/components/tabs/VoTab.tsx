...
<body>
    ...
    <table>
        <tr><th>ลูกค้า (Client)</th><td>${project.client.name}</td></tr>
...
<body>
    ...
    <div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
        <div style="width: 60%">
            <p><strong>ชื่อลูกค้า (Client):</strong> ${project.client.name}</p>
           ...
           {activeTab === 'dashboard' && (
               <div className="animate-in fade-in duration-300">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <button onClick={() => window.print()} className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 hover:bg-gray-200 border border-gray-300"><Printer size={16}/> Print</button>
                    </div>
