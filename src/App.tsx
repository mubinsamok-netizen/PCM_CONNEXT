...
export default function App() {
  ...
  const [view, setView] = useState<'dashboard' | 'project' | 'admin' | 'profile' | 'payment_system'>('dashboard');
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans transition-colors duration-500 relative">
      <NavBar 
         user={user} 
      ...
      {view === 'admin' ? (
        ...
        <DashboardScreen onSelectProject={(p) => { setSelectedProject(p); setView('project'); }} />
      )}
